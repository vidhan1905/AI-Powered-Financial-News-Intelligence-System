...
class StockMapper:
    ...
    def map_company_to_symbol(self, company_name: str) -> Optional[str]:
        ...
        """
        # Direct lookup
        if company_name in self.company_to_symbol:
            return self.company_to_symbol[company_name]
    ...
    def get_stocks_for_sector(self, sector: str) -> List[str]:
        ...
        return self.sector_to_stocks.get(sector_key, [])
    ...
    def map_entity_to_stocks(
        ...
        Args:
            entity_type: Type of entity (company, sector, regulator).
